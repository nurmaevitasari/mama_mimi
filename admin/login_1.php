...
<style>
  ...
  * {
  ...
  body {
      ...
      background: linear-gradient(to top, #4DA5C5 10%, rgba(93, 42, 141, 0.4) 90%) no-repeat
  }
...
<body oncontextmenu='return false' class='snippet-body'>
    <div class="wrapper bg-white">
      <div class="h2 text-center">Mama Mimi</div>
        <div class="h4 text-muted text-center pt-2">Login Admin Shop</div>
          <form class="pt-3" method="POST" action="action_login.php">
              ...
              <div class="col-sm-12">
                <span style="color:red;"><i class="fas fa-exclamation-circle"></i> Username/Password Salah</span>
